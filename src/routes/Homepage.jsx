      ...
      <div className="flex items-center justify-between">
        ...
        <div className="">
          <h1 className="text-gray-800 text-xl md:text-4xl lg:text-5xl font-bold">
            Discover the power of Scripture, and how God’s perspective elevates
            our daily lives.
          </h1>
        ...
        <Link to="write" className="hidden md:block relative">
          ...
          <button className="absolute top-0 left-0 right-0 bottom-0 m-auto w-20 h-20 bg-blue-700 rounded-full flex items-center justify-center">
            <svg
